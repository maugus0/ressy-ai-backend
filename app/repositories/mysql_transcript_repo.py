...
class MySQLTranscriptRepository(MySQLBaseRepository):
    ...
    def create_transcript(self, user_id: Optional[int], order_id: Optional[int], call_log: Dict) -> int:
        """
        ...
        """
        return self._execute_insert(query, (user_id, order_id, json.dumps(call_log)))
