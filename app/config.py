...
class Settings:
    ...
    # POS Catalog Sync Configuration
    POS_CATALOG_SYNC_INTERVAL_MINUTES = int(os.getenv("POS_CATALOG_SYNC_INTERVAL_MINUTES", "1440"))
    POS_WEBHOOK_RETRY_INTERVAL_MINUTES = int(os.getenv("POS_WEBHOOK_RETRY_INTERVAL_MINUTES", "1"))
    POS_WEBHOOK_MAX_RETRY_ATTEMPTS = int(os.getenv("POS_WEBHOOK_MAX_RETRY_ATTEMPTS", "10"))
    POS_WEBHOOK_RETRY_BASE_MINUTES = int(os.getenv("POS_WEBHOOK_RETRY_BASE_MINUTES", "1"))
    POS_WEBHOOK_PROCESSING_STALE_MINUTES = int(os.getenv("POS_WEBHOOK_PROCESSING_STALE_MINUTES", "5"))
