...
class AdminRestaurantService:
    ...
    def create_restaurant(self, data: Dict) -> Dict:
        ...
        try:
            ...
            if restaurant.get("twilio_details"):
                restaurant["twilio_details"] = (
                    json.loads(restaurant["twilio_details"])
                    if isinstance(restaurant["twilio_details"], str)
                    else restaurant["twilio_details"]
                )
            if restaurant.get("deepgram_details"):
                restaurant["deepgram_details"] = (
                    json.loads(restaurant["deepgram_details"])
                    if isinstance(restaurant["deepgram_details"], str)
                    else restaurant["deepgram_details"]
                )
            if restaurant.get("open_table_details"):
                restaurant["open_table_details"] = (
                    json.loads(restaurant["open_table_details"])
                    if isinstance(restaurant["open_table_details"], str)
                    else restaurant["open_table_details"]
                )
    ...
    def get_all_restaurants(
        ...
        try:
            ...
            return {"data": restaurants, "total": total, "page": page, "limit": limit, "total_pages": total_pages}
        except Exception as e:
