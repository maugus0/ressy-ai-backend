...
CREATE TABLE IF NOT EXISTS User_Activity_History (
    ...
    user_id INT NOT NULL COMMENT 'User who performed the action (staff/admin user)',
    ...
    ip_address VARCHAR(45) COMMENT 'IP address of the request (optional)',
    user_agent VARCHAR(500) COMMENT 'User agent of the request (optional)',
